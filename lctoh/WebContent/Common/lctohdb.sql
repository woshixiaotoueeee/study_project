...
CREATE TABLE `address` (
  ...
  `address_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
...
CREATE TABLE `admin` (
  ...
  `admin_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
  PRIMARY KEY (`admin_id`),
  UNIQUE KEY `admin_user` (`admin_user_id`) USING BTREE,
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('123456', '2017-12-20 22:21:58', '10001', '1111111111111111111111111111', '1');
...
CREATE TABLE `city` (
  ...
  `city_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
  PRIMARY KEY (`city_id`),
...
-- Records of city
-- ----------------------------
INSERT INTO `city` VALUES ('1', '北京市', '2017-12-08 23:24:25', '50001', '10001', '1');
...
CREATE TABLE `customer` (
  ...
  `customer_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
  PRIMARY KEY (`customer_id`),
  UNIQUE KEY `customer_user` (`customer_user_id`) USING BTREE,
...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('123456', '琴殇', 'customer/image.jpg', '100.000', '2017-12-03 17:50:10', '20002', '123456', '1');
INSERT INTO `customer` VALUES ('12345678', '去玩儿', 'customer/image.jpg', '200.000', '2017-12-20 22:16:19', '20001', '1111111111111111111111111111', '1');
INSERT INTO `customer` VALUES ('12345678901234567890123456789012', '天问', 'customer/image.jpg', '100.000', '2017-12-03 17:52:43', '20004', '12345678901234567890123456789012', '1');
...
CREATE TABLE `dish` (
  ...
  `dish_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
  PRIMARY KEY (`dish_id`),
...
CREATE TABLE `dish_category` (
  ...
  `dish_category_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
...
CREATE TABLE `harvest_address` (
  ...
  `harvest_address_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
...
CREATE TABLE `order` (
  ...
  `order_delivery_time` datetime NOT NULL COMMENT '订单完成时间',
  ...
  `order_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
...
CREATE TABLE `order_item` (
  ...
  `order_item_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
...
CREATE TABLE `province` (
  ...
  `province_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
...
-- Records of province
-- ----------------------------
INSERT INTO `province` VALUES ('10001', '北京', '2017-12-03 18:22:36', '40001', '1');
INSERT INTO `province` VALUES ('10002', '江西省', '2017-12-03 18:23:36', '40002', '1');
...
CREATE TABLE `restaurant` (
  ...
  `restaurant_deliveryfee` decimal(6,3) NOT NULL COMMENT '配送费',
  `restaurant_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
  PRIMARY KEY (`restaurant_id`),
  UNIQUE KEY `restaurant_user` (`restaurant_user_id`) USING BTREE,
...
CREATE TABLE `restaurant_category` (
  ...
  `restaurant_category_delete_or_not` int(1) DEFAULT '1' COMMENT '是否删除',
...
-- ----------------------------
INSERT INTO `restaurant_category` VALUES ('1', '盖浇饭', '2017-12-08 23:35:52', '30001', '1');
...
CREATE TABLE `rider` (
  ...
  `rider_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
  PRIMARY KEY (`rider_id`),
  UNIQUE KEY `rider_user` (`rider_user_id`) USING BTREE,
...
-- Records of rider
-- ----------------------------
INSERT INTO `rider` VALUES ('123456', '133.000000000', '39.000000000', '2017-12-20 22:37:35', '1111111111111111111111111111', '130003', '1');
...
INSERT INTO `state` VALUES ('130002', '已激活正在使用', '2017-12-20 22:31:34');
INSERT INTO `state` VALUES ('130003', '锁定', '2017-12-20 22:33:08');
INSERT INTO `state` VALUES ('130004', '注销（删号）', '2017-12-20 22:33:44');
...
CREATE TABLE `user` (
  ...
  `user_sex` varchar(10) COLLATE utf8_unicode_ci NOT NULL COMMENT '性别',
  `user_delete_or_not` int(1) NOT NULL DEFAULT '1' COMMENT '是否删除',
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `account` (`user_account`),
  UNIQUE KEY `email` (`user_email`) USING BTREE,
  UNIQUE KEY `phone` (`user_phone`) USING BTREE,
  UNIQUE KEY `code` (`user_code`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1111111111', '12', '11', '1', '1', '1995-09-26 11:12:12', '1', '1', '1');
INSERT INTO `user` VALUES ('1111111111111111111111111111', '100001', '100001', '1234@qq.com', '12345', '2017-12-14 16:46:48', '11', '男', '0');
INSERT INTO `user` VALUES ('121212121', '100003', '100003', 'qwer@qq.com', '12121', '2017-12-03 17:19:51', '121212121', '女', '0');
INSERT INTO `user` VALUES ('123456', '1000001', '100001', '12344@qq.com', '1234533', '2017-12-14 16:46:48', '11111', '保密', '0');
INSERT INTO `user` VALUES ('123456123', '100002', '100002', '21212@qq.com', '1212121', '2017-12-03 17:19:05', '212121', '男', '0');
INSERT INTO `user` VALUES ('12345678901234567890123456789012', '123456', '123456', '123@qq.com', '12345678901', '2017-12-03 17:16:38', 'qwertyuioppoiuytrewqqwertyuioppo', '女', '0');
